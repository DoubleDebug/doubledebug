    ...
    elements: [
      {
        ...
        props: {
          ...
          transform: {
            ...
            xl: 'scale(0.9) translateX(5px) translateY(-30px)',
            '2xl': 'none',
          },
          as: 'h1',
        },
      ...
      },
      {
        ...
        props: {
          ...
          pl: 4,
          transform: {
            base: 'scale(0.8) translateX(-100px) translateY(-60px)',
    ...
    elements: [
      ...
      },
      {
        ...
        props: {
          ...
          color: 'black',
          transform: {
            base: 'scale(0.75) translateX(-100px) translateY(-70px)',
            xl: 'scale(0.9) translateX(-30px) translateY(-35px)',
            '2xl': 'none',
          },
          as: 'h2',
        },
    ...
    elements: [
      {
        ...
        props: {
          ...
          pt: 4,
          transform: {
            base: 'scale(0.8) translateX(-100px) translateY(-30px)',
            xl: 'scale(0.9) translateX(-40px) translateY(0px)',
            '2xl': 'none',
          },
          as: 'h1',
        },
      ...
      },
      {
        ...
        props: {
          ...
          width: '650px',
          transform: {
            base: 'scale(0.7) translateX(-220px) translateY(-60px)',
            xl: 'scale(0.8) translateX(-130px) translateY(-20px)',
    ...
    elements: [
      {
        ...
        props: {
          ...
          color: 'black',
          transform: {
            base: 'scale(0.85) translateX(-50px) translateY(-30px)',
            xl: 'translateX(0px) translateY(-25px)',
            '2xl': 'none',
          },
          as: 'h1',
        },
      ...
      },
      {
        ...
        props: {
          ...
          pl: 40,
          transform: {
            base: 'scale(0.7) translateX(-50px) translateY(-60px)',
            xl: 'scale(0.85) translateX(-90px) translateY(-35px)',
            '2xl': 'scale(0.95) translateX(-20px)',
          },
          as: 'h2',
        },
        duration: 1000,
    ...
    elements: [
      {
        ...
        props: {
          ...
          mt: -4,
          transform: {
            base: 'scale(0.8) translateX(-80px) translateY(-50px)',
            xl: 'translateX(-30px) translateY(-30px)',
            '2xl': 'none',
          },
          as: 'h1',
        },
      ...
      },
      {
        ...
        props: {
          ...
          ml: 6,
          transform: {
            base: 'scale(0.7) translateX(-100px) translateY(-80px)',
            xl: 'scale(0.85) translateX(-20px) translateY(-40px)',
            '2xl': 'none',
          },
          as: 'h2',
        },
    ...
    elements: [
      {
        ...
        props: {
          ...
          mt: -4,
          transform: {
            base: 'scale(0.8) translateX(-50px) translateY(-40px)',
      ...
      },
      {
        ...
        props: {
          ...
          ml: 4,
          transform: {
            base: 'scale(0.7) translateX(-100px) translateY(-70px)',
            xl: 'scale(0.8) translateX(-40px) translateY(-20px)',
            '2xl': 'none',
          },
          as: 'h2',
        },
    ...
    elements: [
      {
        ...
        props: {
          ...
          mt: -8,
          transform: {
            base: 'translateX(-50px) translateY(-40px)',
            xl: 'translateX(20px) translateY(-10px)',
            '2xl': 'none',
          },
          as: 'h1',
    ...
    elements: [
      {
        ...
        props: {
          ...
          mt: 8,
          transform: {
            base: 'scale(0.8) translateX(-100px) translateY(-40px)',
      ...
      },
      {
        ...
        props: {
          ...
          ml: 6,
          transform: {
            base: 'scale(0.75) translateX(-50px) translateY(-60px)',
    ...
    elements: [
      ...
      },
      {
        ...
        props: {
          ...
          ml: 16,
          transform: {
            base: 'scale(0.8) translateX(-20px) translateY(-70px)',
            xl: 'scale(0.85) translateX(0px) translateY(-15px)',
            '2xl': 'none',
          },
          as: 'h2',
